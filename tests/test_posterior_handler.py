...
def test_get_posterior_no_optimization_correct_num_datapoints_and_not_optimized(
    ...
    assert posterior.prior.mean_function.constant.unwrap()[...] == jnp.array([1.0])
    assert posterior.prior.kernel.lengthscale.unwrap()[...] == jnp.array([0.5])
    assert posterior.prior.kernel.variance.unwrap()[...] == jnp.array(1.0)
